...
import { Loading } from "./configurations/JsonDefault.js";
import { EmailsColumns } from "./configurations/ColumnDTSetting.js";
import { SearchIn, buttonActions, rAccess, rSave } from "../businessRules/AdministratorRoles.js";
...
const Mails = () => {
    ...
    const LoadData = async () => {
        try{
            ...
            let mailResult = await rAccess({key: 'administrators', handlEdit:handlEdit, handlDelete:handlDelete});

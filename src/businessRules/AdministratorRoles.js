import { GetAdministratorRoles } from "../context/data/APIs";
import { s3JsonFile } from "../context/data/APIs";

export const AdministratorRoles = async({props}) => {
    try{
        let periodoResult = await GetAdministratorRoles({props:{}});
...
export const rAccess = async ({key , handlEdit, handlDelete}) => {
    try{
